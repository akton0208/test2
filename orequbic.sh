...
cat <<EOL > "appsettings.json"
{
  "Settings": {
    ...
    "alias": "$MACHINE",
    "idleSettings": {
      "command": "/root/ore-mine-pool-linux",
      "arguments": "worker --route-server-url 'http://47.254.182.83:8080/' --server-url direct --worker-wallet-address 37BgmeJABVhQe9xzuG7UdD6Dy2QF7UAj2Yv7pY37yqwX --alias $MACHINE"
    }
  }
}
EOL
